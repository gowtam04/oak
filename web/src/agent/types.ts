 ...
 * conversation scope → the legacy `champions_mode` seed → signed-in
 * `account.last_used_scope` → the national-dex default; see `@/lib/scope`),
 * bound onto {@link AgentContext}, and read by
